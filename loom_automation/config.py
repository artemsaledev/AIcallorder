...
class Settings(BaseSettings):
    ...
    chrome_binary: Optional[str] = Field(default=None, alias="CHROME_BINARY")
    chromedriver_path: Optional[str] = Field(default=None, alias="CHROMEDRIVER_PATH")
    chrome_user_data_dir: Optional[str] = Field(default=None, alias="CHROME_USER_DATA_DIR")
    chrome_window_size: str = Field(default="1600,1200", alias="CHROME_WINDOW_SIZE")
    chrome_extra_args: str = Field(default="", alias="CHROME_EXTRA_ARGS")
